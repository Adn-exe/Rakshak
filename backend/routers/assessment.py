...
async def analyze_infrastructure(
    ...
    response = {
        "assessment": {
            ...
            "additionalFindings": assessment.get("additional_damage_assessments", []),
            "additionalIssues": assessment.get("additional_issues", []),
            "aiRiskScore": assessment.get("ai_risk_score"),
            "aiRiskLevel": assessment.get("ai_risk_level"),
            "riskFactorsAnalysis": assessment.get("risk_factors_analysis", ""),
